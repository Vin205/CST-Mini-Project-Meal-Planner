        ...
        <section id="about-us">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col text-center">
              <div class="pb-3"></div>
                <iframe width="560" height="315" src="./images/s.mp4" frameborder="0" allowfullscreen></iframe>
              </div>
            </div>
          </div>
        </section>

        <section class="my-5" id="poll">
        <div class="pb-5"></div>
                ...
                <MDBRow className='g-0'>
                  ...
                  <MDBCol md='8'>
                    <MDBCardBody>
                      ...
                      <div class="py-2">
                        <button type="button" class="btn btn-primary" onClick={() => { setGoToPoll(true); }}>Vote Now</button>
                      </div>
                    </MDBCardBody>
                  </MDBCol>
                </MDBRow>
                ...
                <MDBRow className='g-0'>
                  ...
                  <MDBCol md='8'>
                    <MDBCardBody>
                      ...
                      <div class="py-2">
                        <button type="button" class="btn btn-primary" onClick={() => { setGoToCreate(true); }}>Search Now</button>
                      </div>
                    </MDBCardBody>
                  </MDBCol>
                </MDBRow>
